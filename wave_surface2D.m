...
for ikx=1:Nx/2+1 % loop over non-neg kx values kx1S
...
% 
Psi1splot = Psi1s(Nx/2:Nx,:) %; temp array for plotting the right half of the symmetrical variance spectrum
% ;Psi1splot = Psi1s  ; for contouring the 2sided spectrum (incl neg kxmath)

contour(1:64,1:64,real(Psi1s))
